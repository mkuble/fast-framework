...
public class FastClassUtils {
	 ...
	 * @return
	 */
	public static Map<Field, Method> findFieldGetMethods(Collection<Field> fields, final Class<?> clazz, final FieldMethodFilter filter){
	 ...
	 * @return
	 */
	public static Map<Field, Method> findFieldSetMethods(Collection<Field> fields, final Class<?> clazz, final FieldMethodFilter filter){
